...
//edit this adamm when you set up the database   mongodb+srv://adam:adaM@1337@comp228.ucw0c.mongodb.net/surveySchema?retryWrites=true&w=majority 
var db = mongo.connect('mongodb+srv://adam:adaM@1337@comp228.ucw0c.mongodb.net/surveySchema?retryWrites=true&w=majority', function(err, response){
    if(err){
        console.log(err);
    }else{
        console.log('Connected to mongo'+ db, ' + ', response);
    }
});
// Start security code
